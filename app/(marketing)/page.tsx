...
const pillars = [
  {
    title: "Talent",
    description: "Create a team of proven producers.",
    icon: "TBD",
    items: [
      "NUPP",
      "Producer per $1M",
      "Developing Candidate Pools",
      "Strictly Define Producer Role",
      "Capital Options",
    ],
  },
  {
    title: "Training",
    description:
      "Leverage the strategy and tactics of top agencies and producers.",
    icon: "TBD",
    items: [
...

  {
    title: "Leadership",
    description:
      "Create a salesforce that knows where they are going and what they need to do to get there.",
    icon: "TBD",
    items: [
      "Higher Sales Goals",
      "Tracking Leading Indicators",
      "Sales Management and Feedback",
  ...
  {
    title: "Execution",
    description: "Get the entire organization rowing in the same direction.",
    icon: "TBD",
    items: ["Vision", "Accountability", "Team Health", "Develop Scorecards"],
  },
];
      ...
      <section className="">
        <div className="mx-auto max-w-screen-xl px-4 py-8 text-center lg:px-12 lg:py-16">
          ...
          <p className="mb-8 text-lg font-normal text-gray-500 dark:text-gray-400 sm:px-16 lg:text-xl xl:px-48">
            We help insurance agencies across the country systematically double
            their revenue with our Four Pillars of Success.
          </p>
        ...
        <div className="mx-auto max-w-screen-xl items-center px-4 py-8 sm:py-16 lg:grid lg:gap-8 lg:px-6 xl:grid-cols-3 xl:gap-24">
          <div className="mb-8 lg:mb-0">
            ...
            <p className="mb-4 text-gray-500 dark:text-gray-400 sm:text-xl">
              Working with over 100 of the top insurance agencies across the
              country, we've identified the four key areas that drive growth and
              success. Each pillar can be used independently, but we've found
              that in combination, they create a powerful engine for growth.
            </p>
            {/* <a
              href="#"
          ...
          <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Talent</h3>
              <p className="text-gray-500 dark:text-gray-400">
                This is the key to success at any agency. We help you create a
                team of proven producers that can help you grow your business.
              </p>
            </div>
            <div>
              <div className="bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                We have trained thousands of producers and know what works.
                Leverage the strategy and tactics of top agencies and producers
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                You need to know where you are going and what you need to do in
                order to get there, right? We help you create a salesforce that
                knows what they need to do to accomplish the mission.
              </p>
            </div>
            <div>
              <div className="bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Leveraging the power of the EOS business operating system, we
                help agencies escape the firedrill most experience and help
                align the entire organization to row in the same direction.
              </p>
            </div>
          </div>
        </div>
